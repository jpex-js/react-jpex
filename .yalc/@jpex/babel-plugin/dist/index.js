...
const shouldUsePublicPath = (state, parent) => {
  ...
  const src = parent == null ? void 0 : (_parent$source = parent.source) == null ? void 0 : (_parent$source$value = _parent$source.value) == null ? void 0 : _parent$source$value[0];
